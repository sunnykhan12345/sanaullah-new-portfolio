    ...
    >
      <div className="relative aspect-[16/9] overflow-hidden bg-white">
        <Image
          ...
          className="object-contain object-top p-2 transition duration-700 group-hover:scale-[1.02]"
        />

        <Badge className="absolute left-4 top-4 border-white/10 bg-black/55 text-white backdrop-blur-xl">
          {primaryCategory}
        </Badge>

        {project.status && (
          <Badge className="absolute right-4 top-4 border-white/10 bg-black/55 text-white backdrop-blur-xl">
            {project.status}
          </Badge>
        )}
      </div>
